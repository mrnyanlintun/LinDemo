...
(function () {
  ...
  const TOPICS = [
    ...
    },
    {
      ...
      body: "Module 02 watches for accumulating drift. CUSUM sums small deviations over time so a slow slide is caught before any single period trips a threshold. When the cumulative drift crosses the control threshold the signal is 'breached' and feeds the governance rules — including the 'Anomaly without narrative' conflict when the document record offers no explanation."
    },
    {
      id: "module03",
